	...
	<div class="breadcrumbs">
		<div class="container">
			<ol class="breadcrumb breadcrumb1 animated wow slideInLeft" data-wow-delay=".1s">
				<li><a href="/My_project"><span class="glyphicon glyphicon-home" aria-hidden="true"></span>Home</a></li>
...
<!-- login -->
	<div class="login">
		<div class="container">
			...
			<h4 class="animated wow slideInUp" data-wow-delay=".1s">For New People</h4>
			<p class="animated wow slideInUp" data-wow-delay=".1s"><a href="register.html">Register Here</a> (Or) go back to <a href="index.html">Home<span class="glyphicon glyphicon-menu-right" aria-hidden="true"></span></a></p>
		</div>
	</div>
<!-- //login -->
<!-- footer -->
