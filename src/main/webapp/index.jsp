				...
				<div class="logo-nav-left1">
					...
					<div class="collapse navbar-collapse" id="bs-megadropdown-tabs">
						<ul class="nav navbar-nav">
							<li class="active"><a href="/My_project/" class="act">Home</a></li>	
							<!-- Mega Menu -->
							<li class="dropdown">
		...
		<div class="container">
			...
			<div class="new-collections-grids">
				...
				<div class="col-md-6 new-collections-grid">
					<div class="new-collections-grid1 new-collections-grid1-image-width animated wow slideInUp" data-wow-delay=".1s">
						<div class="new-collections-grid1-image">
	...
	<div class="timer">
		<div class="container">
			<div class="timer-grids">
				...
				<div class="col-md-4 timer-grid-right animated wow slideInRight" data-wow-delay=".1s">
